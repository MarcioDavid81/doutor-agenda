...
export default function PrivacyPage() {
  return (
    <div className='flex flex-col gap-4 p-4'>
      ...
      <p>A sua privacidade é importante para nós. É política do Dr Agenda respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Dr Agenda, e outros sites que possuímos e operamos.</p>
